                ...
                try { 
                    ...
                    if ($existing_posts) {
                        foreach ($existing_posts as $post) {
                            $post_id = $post->ID;
                            $post_title = $solicitud->perfil;
                            $post_url = $solicitud->perfil.' N'.$solicitud->idSolicitud;
                            $requisitos = '';
                            $post_status = 'publish';
                            ...
                            $post_data = array(
                                ...
                                'post_name' => sanitize_title($post_url),
                            ...
                            update_post_meta($post_id, 'urlVacante', $solicitud->url);
                    ...
                    // Si no creamos el post
                        ...
                        if (is_wp_error($new_post_id)){                    
                            ...
                            update_post_meta($new_post_id, 'urlVacante', $solicitud->url);
